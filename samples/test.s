...
Ltmp2:
	...
	movl	%edi, -4(%rbp)
	.loc	1 3 10 prologue_end     ## test.c:3:10
Ltmp3:
	movl	-4(%rbp), %edi
	.loc	1 3 14 is_stmt 0        ## test.c:3:14
	imull	-4(%rbp), %edi
	.loc	1 3 3                   ## test.c:3:3
	movl	%edi, %eax
	popq	%rbp
	retq
Ltmp4:
...
Linfo_string:
	...
	.asciz	"test"                  ## string offset=94
	.asciz	"int"                   ## string offset=99
	.asciz	"num"                   ## string offset=103
...
Lset1 = Lline_table_start0-Lsection_line ## DW_AT_stmt_list
	...
	.byte	2                       ## Abbrev [2] 0x2e:0x2e DW_TAG_subprogram
	.quad	Lfunc_begin0            ## DW_AT_low_pc
	.quad	Lfunc_end0              ## DW_AT_high_pc
...
Lnames_begin:
	...
	.long	0                       ## Bucket 0
	.long	2090756197              ## Hash in Bucket 0
